...
const FAR_CLOUDS: Cloud[] = [
  { x: 0.02, y: 0.5, scale: 0.28, depth: 0.04, puffs: [{ x: -0.1, y: 0.01, r: 0.08, alpha: 0.5 }, { x: 0.0, y: -0.01, r: 0.09, alpha: 0.55 }, { x: 0.1, y: 0.01, r: 0.08, alpha: 0.5 }] },
  { x: 0.48, y: 0.54, scale: 0.32, depth: 0.07, puffs: [{ x: -0.11, y: 0.01, r: 0.08, alpha: 0.52 }, { x: -0.01, y: -0.02, r: 0.1, alpha: 0.58 }, { x: 0.11, y: 0.02, r: 0.08, alpha: 0.52 }] },
  { x: 0.92, y: 0.57, scale: 0.3, depth: 0.09, puffs: [{ x: -0.1, y: 0.0, r: 0.08, alpha: 0.5 }, { x: 0.0, y: -0.02, r: 0.09, alpha: 0.56 }, { x: 0.1, y: 0.01, r: 0.08, alpha: 0.5 }] },
];
